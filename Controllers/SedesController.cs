...
namespace ProyectoFinal_.Controllers
{
    public class SedesController : Controller
    {
        ...
        {
              return _context.Sede != null ? 
                          View(await _context.Sede.ToListAsync()) :
                          Problem("Entity set 'ProyectoFinal_Context.Sede'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("SedeID,NombreCiudad")] Sede sede)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SedeID,NombreCiudad")] Sede sede)
        {
            if (id != sede.SedeID)
            {
                return NotFound();
